...
var Dictionary = /** @class */ (function () {
    ...
    Object.defineProperty(Dictionary.prototype, "locale", {
        get: function () {
            return LOCALE;
        },
        set: function (value) {
     ...
     */
    Dictionary.prototype.getFieldMessage = function (locale, field, key, data) {
    ...
    Dictionary.prototype.getAttribute = function (locale, key, fallback) {
    ...
    Dictionary.prototype._hasAttribute = function (locale, key) {
...
var DictionaryResolver = /** @class */ (function () {
    function DictionaryResolver() {
    }
    DictionaryResolver.setDriver = function (implementation) {
    ...
    DictionaryResolver.getDriver = function () {
...
var RuleContainer = /** @class */ (function () {
    ...
    RuleContainer.extend = function (name, schema) {
        // Rule already exists.
        var rule = __assign({ immediate: true, computesRequired: false }, schema);
    ...
    RuleContainer.isImmediate = function (name) {
...
var Validator = /** @class */ (function () {
    function Validator(options) {
        if (options === void 0) { options = { bails: true }; }
        this.bails = !!(!isNullOrUndefined(options && options.bails) ? options.bails : true);
    }
    Object.defineProperty(Validator.prototype, "locale", {
        /**
    ...
    Object.defineProperty(Validator, "locale", {
        get: function () {
     ...
     */
    Validator.prototype.localize = function (lang, dictionary) {
        Validator.localize(lang, dictionary);
    };
    /**
     * Adds and sets the current locale for the validator.
     */
    Validator.localize = function (lang, dictionary) {
        var _a;
        if (isObject(lang)) {
        ...
        if (dictionary) {
            ...
            if (!locale)
                return;
            DictionaryResolver.getDriver().merge((_a = {},
                _a[locale] = dictionary,
                _a));
        }
        if (lang) {
            // set the locale.
     ...
     */
    Validator.prototype.validate = function (value, rules, options) {
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var field, result, errors, ruleMap;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._validate(field, value, options)];
                    case 1:
                        result = _a.sent();
                        errors = [];
                        ruleMap = {};
     ...
     */
    Validator.prototype._validate = function (field, value, _a) {
        var _b = (_a === void 0 ? {} : _a).isInitial, isInitial = _b === void 0 ? false : _b;
        return __awaiter(this, void 0, void 0, function () {
            var _c, shouldSkip, errors, rules, length, i, rule, result;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, this._shouldSkip(field, value)];
                    case 1:
                    ...
                    case 2:
                        ...
                        rule = rules[i];
                        return [4 /*yield*/, this._test(field, value, {
                                name: rule,
    ...
    Validator.prototype._shouldSkip = function (field, value) {
        return __awaiter(this, void 0, void 0, function () {
            var requireRules, length, errors, isRequired, i, rule, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
     ...
     */
    Validator.prototype._test = function (field, value, rule) {
        return __awaiter(this, void 0, void 0, function () {
            var ruleSchema, params, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        params = this._buildParams(rule.params, ruleSchema.params, field.crossTable);
                        return [4 /*yield*/, ruleSchema.validate(value, params)];
                    case 1:
                        result = _a.sent();
                        if (!isObject(result)) {
    ...
    Validator.prototype._buildParams = function (provided, defined, crossTable) {
        var params = {};
     ...
     */
    Validator.prototype._createFieldError = function (field, rule, params, data) {
        var _this = this;
        return {
            field: field.name,
            ...
            rule: rule.name,
            regenerate: function () {
                return _this._formatErrorMessage(field, rule, params, data);
            }
        };
    };
    /**
     ...
     */
    Validator.prototype._formatErrorMessage = function (field, rule, params, data) {
        if (data === void 0) { data = {}; }
        var name = this._getFieldDisplayName(field);
        data.targetName = field.names[rule.name] || '{target}';
        data.targetName = DictionaryResolver.getDriver().getAttribute(this.locale, data.targetName) || data.targetName;
        return DictionaryResolver.getDriver().getFieldMessage(this.locale, field.name, rule.name, [name, params, data]);
    };
    /**
     * Resolves an appropriate display name, first checking 'data-as' or the registered 'prettyName'
     */
    Validator.prototype._getFieldDisplayName = function (field) {
 ...
 */
function extendRule(name, schema) {
    var _a, _b;
    if (schema.message) {
        DictionaryResolver.getDriver().merge((_a = {},
            _a[DictionaryResolver.getDriver().locale] = {
                messages: (_b = {},
...
function onRenderUpdate(vm, model) {
    ...
    vm.validateSilent().then(vm.immediate || vm.flags.validated ? vm.applyResult : function (x) { return x; });
}
...
var ValidationProvider = Vue.extend({
    ...
    computed: {
        ...
        normalizedEvents: function () {
            ...
            return normalizeEvents(on || []).map(function (e) {
                if (e === 'input') {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, VALIDATOR.validate(this.value, rules, {
                                    name: this.name,
...
var ValidationObserver = Vue.extend({
    ...
    methods: {
        ...
        validate: function (_a) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0: return [4 /*yield*/, Promise.all(values(this.refs).map(function (ref) {
                                return ref[silent ? 'validateSilent' : 'validate']().then(function (r) { return r.valid; });
                            }).concat(this.observers.map(function (obs) { return obs.validate({ silent: silent }); })))];
                        case 1:
                            results = _c.sent();
        ...
        restoreProviderState: function (provider) {
            var state = this.inactiveRefs[provider.vid];
            provider.setFlags(state.flags);
            provider.applyResult(state);
            this.$delete(this.inactiveRefs, provider.vid);
        },
        removeProvider: function (vid) {
...
function withValidation(component, mapProps) {
    ...
    hoc.render = function (h) {
        ...
        var props = __assign({}, this.$attrs, (_a = {}, _a[prop] = model.value, _a), mapProps(vctx));
        return h(options, {
            attrs: this.$attrs,
            props: props,
            on: listeners
...
var setI18nDriver = function (driver) {
    DictionaryResolver.setDriver(driver);
};
var setMode = function (mode, implementation) {
    setConfig({ mode: mode });
    if (!implementation) {
        return;
    }
...
export { ValidationObserver, ValidationProvider, Validator, configure, extend, setI18nDriver, setMode, version, withValidation };
